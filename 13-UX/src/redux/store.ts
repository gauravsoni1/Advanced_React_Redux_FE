...
import { publicApiSlice } from '../hooks/api/baseApiConfig';
...
export const store = configureStore({
    ...
    middleware: (defaultMiddle) =>
        defaultMiddle().concat(userApi.middleware, propertyApi.middleware, notificationApi.middleware, publicApiSlice.middleware)
})
